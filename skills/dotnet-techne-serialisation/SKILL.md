...
## Akka.NET Serialisation

For Akka.NET actor systems, use schema-based serialisation:

```hocon
akka {
  actor {
    serializers {
      messagepack = "Akka.Serialisation.MessagePackSerializer, Akka.Serialisation.MessagePack"
    }
    serialisation-bindings {
...
See [Akka.NET Serialisation Docs](https://getakka.net/articles/networking/serialisation.html).
...
// Don't use reflection serialisation for hot paths
...
- **System.Text.Json Source Generation**: https://learn.microsoft.com/en-us/dotnet/standard/serialisation/system-text-json/source-generation
- **Protocol Buffers**: https://protobuf.dev/
- **MessagePack-CSharp**: https://github.com/MessagePack-CSharp/MessagePack-CSharp
- **Akka.NET Serialisation**: https://getakka.net/articles/networking/serialisation.html
